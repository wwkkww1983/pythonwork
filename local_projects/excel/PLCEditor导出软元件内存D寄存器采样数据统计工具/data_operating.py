...
def read_and_write(dirpath):
    ...
    tarketbook.save(r'C:\Users\fan\Desktop\哈巴机实验-范春回\小马实验数据\2017.9.2 时间测试\处理结果\已处理表格.xls')
...
if __name__ == '__main__':
    dir_path = r'C:\Users\fan\Desktop\哈巴机实验-范春回\小马实验数据\2017.9.2 时间测试'

    read_and_write(dir_path)
